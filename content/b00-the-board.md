---
title: The Board
kicker: ELDORIA UNIVERSITY, OAKHAVEN · EIGHTEEN JOBS
subtitle: Levels 1–5 · two to four hours each · take one down and go
number: 00
head: THE BOARD
headright: ELDORIA UNIVERSITY, OAKHAVEN
---

:::pitch
Eighteen jobs, pinned up outside the Bursar's office, in a university that has decided what its students are worth and printed it on the notices. Take one down. Nobody will stop you and nobody will come with you.
...
| 15 | Walk Me Home | Easy | escort | 1 | **beats** |
| 16 | Six Hundred Dinners | Easy | dungeon | 1 | **map** |
| 17 | Lost Property | Easy | investigation | 1 | **web** |
| 18 | The Coach Leaves At Six | Easy | travel | 1 | **beats** |
...
:::box red | WHAT THE UNIVERSITY IS
Eldoria is solvent, ancient, and administratively hostile. Departments do not co-operate. Finance holds every claim pending a section nobody will fill in. Casual staff are hired by the bracket and the bracket is printed on the notice.
...
**Between the hard ones**, put a level one. Four of them are there for exactly that, they take two hours, and they are the only jobs on this board where the university is not the problem.
:::

:::box gold | WHAT A JOB COSTS
The pay is printed on every notice and it is an insult on every notice: eight to forty gold, a coat, half a cheese, a hot meal, the loan of a horse. Nobody on this board is getting rich.

What they are actually paid in is standing. Finish a job and the person who posted it will open a door for them afterwards -- a kitchen, a lodge, a lab, a stable, a night porter's keys. That is the currency this university runs on and it is the only one it cannot withhold pending a section.
:::
:::

:::valve
If the table is between jobs: the board has a new notice on it, and it is job 13, and it is dated for the day after tomorrow.
If a job goes badly: it stays gone badly. The doom clock on that sheet runs while they take the next one down.
If they want to go straight back: Finance requires a completion form for the previous job first.
If the table needs a night off: take 15, 16, 17 or 18. Nobody dies in those four and the pay is terrible.
:::
