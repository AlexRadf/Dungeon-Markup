---
title: Lost Property
kicker: JOB 17 · THE BOARD · EASY · INVESTIGATION
subtitle: The Porters' Lodge, back room · Level 1 · Two hours · 15 gp, or the thing you lost
number: 17
head: JOB 17 · LOST PROPERTY
headright: THE BOARD
---
...
2. It sorts by need, not by ownership, and it has been right eleven times out of eleven this term.
3. The unyeared shelf is the only shelf it uses. The porters will tell you there is no such shelf, standing in front of it.
4. The second hand is not Prithe's. It learned to write by copying her catalogue for forty years.
5. It writes the claimant's name in the book before the claimant comes in. Every time. Check the ink.
6. It cannot read a name as ownership. It has no idea what ownership is and would be appalled.
7. Give it one rule it can follow -- a ledger, a column, anything written down -- and it will follow that instead, exactly, forever.
8. Marrable already knows. He has known since Michaelmas. What he wants is a version of it he can put in front of Finance.
:::

:::cols 2
:::box red | TROUBLE
- Thursday. Finance do not audit sympathetically and they will want a name in the column.
- Eleven students have been made happy by this and none of them wants their own thing back.
- It hides when looked for, and the back room is nine hundred square feet of shelving to look in.
:::

:::box gold | WAYS OUT
- Write it a rule. A ledger of ownership, in a hand it will copy, and it keeps the Lodge in perfect order forever.
- Let it go on matching, and make it sign the column. An audit wants a signature, not a person.
- Ask the eleven. If they all say keep it, there is nothing to give back, and Thursday is a paperwork problem.
:::

:::npc Gerrit Marrable | Human · Head Porter, twenty-two years · knows, and has decided not to know
WANT: Something he can put in front of Finance on Thursday with his name under it.
VOICE: Flat, courteous, finishes your sentence with the correct word.
...
:::item The Ledger of Ownership | Wondrous, common -- and only if somebody writes it
A ruled book, a column for the item, a column for the owner. Left open on the counter overnight it is filled in by morning, correctly, in that very small script, and thereafter the Lodge returns exactly what was handed in and nothing else -- which is a worse outcome for at least four of the eleven, and the table should be allowed to notice.
:::

:::valve
If it's dragging: a twelfth claim comes in at the counter while they are standing there, and the name is already written.
If it's going fast: it leaves something on the shelf for one of the party. Their name is on the tag, in that hand.
Cliffhanger: they write the ledger, and on the last page, in a much smaller hand: *and who does the sorter belong to.*
:::
